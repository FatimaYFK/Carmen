...
<html lang="en">
  ...
  <body>
	...
	<div class="page" style="background-color: burlywood; opacity: 0.7; margin-top: 15px; margin-bottom: 250px;">
	<div class='container'>
		<div class="main-title" style="color: black; font-family: fantasy;" >
		...
		<form action='' method='get'>
			  ...
			  <button type="submit" class="btn btn-primary" style="margin-left: 41%; margin-right: 7%; margin-top: 4%; margin-bottom: 1%;">Submit</button>
