...
if(isset($_POST["register"]))
{
	...
	else
	{
		...
		if(isset($result))
		{
			...
			$mail->Username = 'carmenkaffeevalidation@gmail.com';					//Sets SMTP username
			$mail->Password = 'kahvedunyam2020';					//Sets SMTP password
			$mail->SMTPSecure = 'ssl';							//Sets connection prefix. Options are "", "ssl" or "tls"
			$mail->From = 'carmenkaffeevalidation@gmail.com';			//Sets the From email address for the message
			$mail->FromName = 'carmenkaffeevalidation@gmail.com';					//Sets the From name of the message
