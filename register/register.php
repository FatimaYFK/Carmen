...
if(isset($_POST["register"]))
{
	...
	else
	{
		...
		if(isset($result))
		{
			$base_url = "http://localhost:8080/carmen/register/";  //change this baseurl value as per your file path
			$mail_body = "
			...
			<p>Best Regards,<br />carmen caffee</p>
			";
			...
			$mail->Username = 'carmenvalidation@gmail.com';					//Sets SMTP username
			$mail->Password = 'kahvedunyam2020';					//Sets SMTP password
			$mail->SMTPSecure = 'ssl';							//Sets connection prefix. Options are "", "ssl" or "tls"
			$mail->From = 'carmenvalidation@gmail.com';			//Sets the From email address for the message
			$mail->FromName = 'carmenvalidation@gmail.com';					//Sets the From name of the message
...
<html>
	<head>
		<title>Carmen Register Login ☕</title>		
...
.container { 
  ...
  background-size: cover;
	...
	<body background="img/bg-body.jpg">
		<br />
		<div class="container" style="width:100%; max-width:600px">
			<h2 align="center">Register Carmen Kaffee</h2>
			<br />
